...
namespace DesignPatterns.Adapter
{
    class Client : IClient
    {
        ...
        public static void DisplayContents(List<Book> books, DateTime oldestDate)
        {
            ...
            {
                Console.WriteLine(format, book.Title, book.Author, book.PublishingDate.Year, book.Cost);
            }
